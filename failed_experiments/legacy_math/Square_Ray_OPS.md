...
This toolkit provides algorithms for navigating the Power-of-Two Square Odd Rays construction. All core operations use **NO TRIGONOMETRY** — only integer comparisons, rational arithmetic, and bitwise operations.
...
git clone https://github.com/nmicic/p2-odd-rays-visual-math-toy.git
cd p2-odd-rays-visual-math-toy
...
## Code Examples (Archived - For Reference Only)

**NOTE: These are archived code examples. No claims are made about utility or applications.**

```python
# Example of using the archived toolkit (NOT recommended for any practical use)
from square_rays_ops import decompose
d = decompose(12)
print(f"n={d.n}, core={d.core}")
```
...
**This is archived, experimental code. NOT maintained, NOT for production use.**
No performance benchmarks or claims are made. This documentation is kept for historical reference only.
...
**GitHub:** https://github.com/nmicic/p2-odd-rays-visual-math-toy/
