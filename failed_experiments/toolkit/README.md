...
This creates a **deterministic reversible encoding** explored as a mathematical curiosity. No practical applications are claimed.
...
This is archived, experimental code. No benchmarks or performance claims are made.
No use cases are recommended - this is kept for historical reference only.
...
This is a toy hobby project. It is NOT research, NOT peer-reviewed, and NOT for any practical use.
No claims are made about performance, advantages, or benefits.
The "encryption" in theta_codec is XOR-based obfuscation, NOT cryptographically secure.
