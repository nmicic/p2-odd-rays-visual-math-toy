...
# NO CLAIMS are made about performance or comparisons.
# Do NOT interpret output as validated benchmarks.
#
# For reference, see:
#   - cuda/theta_cuda_v1.2.cuh
#   - cuda/THETA_SPEC_v1.2.md
"""
theta_benchmark.py - Archived Toy Exploration Script

WARNING: This is archived, experimental code. NOT a benchmark.
No performance claims are made. Output is for curiosity only.
