...
3D Extension of Power-of-Two Square Odd Rays: Cube Shell Mapping
...
Speculative Exploration Directions (NOT tested, NOT claimed to work):
    - Integer-to-direction encoding experiments
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="3D Cube Shell Mapping - Extension of Power-of-Two Square Odd Rays",
