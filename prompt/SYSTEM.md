...
Authoritative Context Specification for Power-of-Two Square Odd Rays
...
This document defines the canonical definitions, invariants, constraints, and reasoning rules for the Power-of-Two Square Odd Rays construction.
LLMs should adhere to this spec for consistency.

This project is a **toy construction-based geometric visualization**, not mathematics research.
All structure arises from explicit definitions. No claims are made about significance or utility.
...
**Important**: Theta positions are local to each shell and should not be treated as global indices.
...
Properties (construction consequences):
- theta_key is odd
...
### 3.2 Ray Invariants (construction consequences)
...
The AI should not assign arithmetic meaning to geometric patterns.
...
Each respects the core invariants defined above.
...
- Should not treat theta_pos as global
- Should not infer mathematical significance
- Should not redefine core logic
- Should not introduce trigonometry or floats in core logic
- Should not propose new geometry unless explicitly asked

---

## 7. REPORTING PROTOCOL

Responses should use this schema when analyzing or describing:
