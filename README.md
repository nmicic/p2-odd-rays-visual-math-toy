...
- **Not a hash for routing or load balancing**
...
| File | Description |
|------|-------------|
| `cuda/theta_cuda_v1.2.cuh` | Experimental CUDA header |
| `cuda/theta_cuda_benchmark_v1.2.cu` | Example mapping generator |
| `cuda/THETA_SPEC_v1.2.md` | Mathematical description |
| `python/theta_toolkit.py` | Toy CPU reference |
